...
Uma aplicação web (dashboard SPA com Flask, HTML5, Vanilla CSS e JS) que realiza auditoria automática de servidores web:
...
Uma aplicação web (dashboard SPA com Flask, HTML5, Vanilla CSS e JS, com tema Âmbar/Laranja) voltada para a identificação de falhas de injeção de comandos SQL (SQL Injection):
